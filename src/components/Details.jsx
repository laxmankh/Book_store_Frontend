...
const Details = () => {
  const onSubmit = async (event) => {
    ...
    if (res.success) {
      Swal.fire({
        title: "Success!",
        text: "Book purchased successfully! Delivered soon",
        icon: "success",
      });
    } else {
      Swal.fire({
    ...
    <>
      <div className="main  dark:bg-slate-900 dark:text-white dark:border">
        <div class="grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-4xl bg-white font-[sans-serif]">
          <div>
            <h1 class="text-gray-800 text-3xl font-extrabold">Purchase Book</h1>
            <p class="text-sm text-gray-500 mt-4">
              Fill in your details and book information to complete the
              purchase.
            </p>
          ...
          <form class="ml-auto space-y-4" onSubmit={onSubmit}>
            ...
            <input
              type="text"
              placeholder="bookTitle And Type"
              name="BookTitle and Type"
              class="w-full rounded-md py-3 px-4 bg-gray-100 text-gray-800 text-sm outline-blue-500 focus:bg-transparent"
            />
            {/* <textarea
              type="text"
